...
import os
import math
import pygame.freetype  # Usando freetype que não sofre com o bug do Python 3.14
...
# --- Fontes Adaptadas com Freetype (Versão Corrigida Sem Erros) ---
class AdaptadorFonte:
    ...
    def get_linesize(self):
        # Usando o tamanho real da fonte + um espaçamento seguro
...
class CosmoMind:
    ...
    def _d_jogo_area(self, correta):
        ...
        desenhar_asteroide(int(self.ast_x), int(ast_y_vis), self.ast_raio, self.ast_rot, self.ast_vel)
